...
public final class LiveState: ObservableObject {
    ...
    @Published public var deviceModel: String = WhoopDeviceModel.unknown.rawValue
    @Published public var customProtocolAvailable: Bool = false
    @Published public var standardHeartRateAvailable: Bool = false
    @Published public var standardBatteryAvailable: Bool = false
    ...
    public var protocolMode: String {
        if customProtocolAvailable && bonded { return "Custom + standard BLE" }
        if standardHeartRateAvailable || standardBatteryAvailable { return "Standard BLE" }
        return "Scanning"
    }
