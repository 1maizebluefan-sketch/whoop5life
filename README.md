...
WHOOP 4.0 is the only fully decoded custom-protocol target today. WHOOP 5.0, WHOOP MG,
and WHOOP Life are supported through standard Bluetooth LE where available: Heart Rate
Measurement (`0x180D/0x2A37`, HR + R-R intervals) and Battery (`0x180F/0x2A19`).

The 5.0/MG/Life private sync protocol is treated as experimental until independently
verified captures exist. Cloud and regulated Life features such as ECG, irregular heart
rhythm notifications, clinician access, AI coaching, labs, and medical reports are not
recreated by this project; the app can surface local data and placeholders for those
domains, but they require official services or new owner-captured interoperability work.
